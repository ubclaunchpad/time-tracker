...
class _scheduleTaskScreenState extends State<StatefulWidget> {
  ...
  Widget renderTaskScheduling() => Column(
        ...
        children: <Widget>[
          ...
          _renderSideBySideText('Start time', startTextFieldController,
              'End time', endTextFieldController),
          SizedBox(height: 30),
  ...
  Widget _renderTextField(String title, TextEditingController textFieldLabel,
          int maxFieldLines) =>
      TextField(
  ...
  Widget _renderSideBySideText(
          String left,
          TextEditingController leftFieldLabel,
          String right,
          TextEditingController rightFieldLabel) =>
      Row(
